...
{
    public class AssetProxyConnector : ServiceConnector
    {
        ...
        // Called from Robust
        public AssetProxyConnector(IConfigSource config, IHttpServer server, string configName) : this(config, server, configName, null)
        {
